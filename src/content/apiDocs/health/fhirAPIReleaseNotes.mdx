...
Populating 'verificationStatus' on the 'Condition' resource which was previously 'unconfirmed'. 

The R4 Immunization FHIR mapping has been enhanced to include the following changes:
  -  ‘primarySource’ now supports the true Boolean value whereas previously it was always ‘true.’
