...
The PKCE flow ([RFC 7636](https://tools.ietf.org/html/rfc7636)) is used by public applications that are unable to safely store a *client secret* such as a navite mobile app.
