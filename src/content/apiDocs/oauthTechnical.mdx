...
A user will only be prompted to consent to a particular client to use their data once; however, it is possible to revoke these `grants` for a specified user and client in the Sandbox environment with the following endpoint:
