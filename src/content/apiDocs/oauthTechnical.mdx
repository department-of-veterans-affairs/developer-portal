...
Initiate the OpenID Connect authorization by directing Veterans or VSO's using your application to `https://dev-api.va.gov/oauth2/authorization` with the following query parameters:
...
* `redirect_uri` - required - the URL you supplied that the Veteran or VSO will be redirected to after authorizing your application
...
After the Veteran or VSO confirms they want to authorize your application to access their data, their browser will be redirected to your application with a request like this:
