...
The _lastUpdated sort parameter can be used to select resources based on the last time they were changed. It also lets you specify the arrangement of responses in ascending or descending order by certain other parameters, which are listed in the [Patient Health API (FHIR) OpenAPI specification](https://api.va.gov/internal/docs/fhir-r4/v0/openapi.json). 
---
### June 21, 2022
