VA’s Health API allow a user/application to make queries that will return Veteran health records stored in a synthetic Veteran health database without interacting with or understanding the inner workings of VA systems.
...
The Health API require you to leverage our authentication protocol. We have a specific guide for authorization, [go to our Authorization documentation](/explore/health/docs/authorization).
