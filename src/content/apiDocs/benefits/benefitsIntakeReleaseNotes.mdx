### May 24, 2021
(v1) We have turned Veteran first and last name field validations back on as per May 17 release notes below. Now we are also allowing spaces in these fields, including leading and trailing spaces (white space). 
delete me
