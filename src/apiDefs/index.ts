...
export interface IApiDescription {
  ...
  // Allow shell API descriptions to give visibility to specific subsets of APIs as requested by VA
  // e.g., FHIR R4 Profile => Urgent Care API
