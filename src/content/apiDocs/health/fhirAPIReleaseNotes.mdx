### April 12, 2022
We have made backend changes to the Veterans Health API that optimize performance, promote stability, and reduce maintenance efforts for R4 and DSTU2 AllergyIntolerance and Procedure resources. As a result, AllergyIntolerance and Procedure identifiers have changed. These changes do not impact consumers, however, as all cross-resource references remain valid and old identifiers are be honored for read operations. 
