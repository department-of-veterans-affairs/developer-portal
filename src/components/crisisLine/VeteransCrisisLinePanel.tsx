...
export default class VeteransCrisisLinePanel extends React.Component {
  private firstListItemLink = React.createRef<HTMLAnchorElement>();
  
  public componentDidUpdate() {
    if (this.firstListItemLink.current) {
      ...
      <div className={classNames('va-crisis-panel', 'va-api-crisis-panel', 'vads-u-max-width--none', 'vads-u-color--base')}>
        <div className="va-crisis-panel-body">
          ...
          <ul className={classNames(
            ...
            <CrisisPanelInfo target="tel:18002738255" icon={faPhone}>
