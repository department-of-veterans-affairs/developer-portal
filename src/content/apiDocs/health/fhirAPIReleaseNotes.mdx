### August 24, 2021
Added the `code` data to R4 `AllergyIntolerance` resource to be compliant with [US Core Implementation Guide](http://hl7.org/fhir/us/core/StructureDefinition-us-core-allergyintolerance.html)

Updated `Condition` resource to include both [SNOMED CT](http://snomed.info/sct) and [ICD-10-CM] codings when both are available.
---
### May 4, 2021
