...
class SwaggerDocs extends React.Component<ISwaggerDocsProps, { json: object, url: string, version:string, metadata: any}> {
    ...
    public getCurrentVersion(metadata:any) {
      return metadata.meta.find((metaObject:any) => metaObject.status === "Current Version").version
    }
