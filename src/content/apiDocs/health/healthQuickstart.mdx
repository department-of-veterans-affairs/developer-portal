 ...
 * {{ process.env.REACT_APP_VETSGOV_SWAGGER_API }}/services/fhir/v0/argonaut/data-query/
 * {{ process.env.REACT_APP_VETSGOV_SWAGGER_API }}/services/fhir/v0/dstu2/
 * {{ process.env.REACT_APP_VETSGOV_SWAGGER_API }}/services/fhir/v0/r4/
 * {{ process.env.REACT_APP_VETSGOV_SWAGGER_API }}/services/community-care/v0/eligibility

Accordingly, the FHIR conformance statements can be retrieved from:

 * {{ process.env.REACT_APP_VETSGOV_SWAGGER_API }}/services/fhir/v0/argonaut/data-query/metadata
 * {{ process.env.REACT_APP_VETSGOV_SWAGGER_API }}/services/fhir/v0/dstu2/metadata
 * {{ process.env.REACT_APP_VETSGOV_SWAGGER_API }}/services/fhir/v0/r4/metadata
