...
-  Previously the facilities in the response had be sorted by facility type first and then distance, now the closest facilities to the requested location will be returned first regardless of facility type [View code change(s)](https://github.com/department-of-veterans-affairs/vets-api/pull/3461)
