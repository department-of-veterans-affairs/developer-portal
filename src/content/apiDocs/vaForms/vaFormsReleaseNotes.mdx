### June 4, 2021
(v0) We added a new searching algorithm that applies spell checking, full text search and trigram search. [#7108](https://github.com/department-of-veterans-affairs/vets-api/pull/7108)
---
