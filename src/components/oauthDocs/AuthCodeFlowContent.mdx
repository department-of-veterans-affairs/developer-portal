...
<div></div><CodeWrapper key={`snippet-1-${props.selectedOption}`}>
...
<div></div><CodeWrapper key={`snippet-4-${props.selectedOption}`}>
...
<div></div><CodeWrapper key={`snippet-6-${props.selectedOption}`}>
...
<div></div><CodeWrapper key={`snippet-10-${props.selectedOption}`}>
