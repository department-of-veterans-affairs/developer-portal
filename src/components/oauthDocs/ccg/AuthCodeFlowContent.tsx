  ...
  return (
    <div>
      ...
      <p>
        ...
        SMART-on-FHIR on top of a commercial authorization provider. You can programmatically pull
        the <code>issuer</code> from the metadata at{' '}
      ...
      <p>
        Sign your JWT using your RSA-generated private key, which you will use as a client
        assertion. An example for what the structure will look like is:
        <CodeWrapper>
          <ReactMarkdown
            ...
            {`~~~json
{
  ...
  "jti": "23f8f614-72c3-4267-b0da-b8b067662c74"
      ...
      <p>
        Lighthouse recommends also providing launch context requirements using the launch parameter
        and launch scope, if applicable. These limit the scope of an access token by indicating the
        token is for a specific patient or encounter. If used, the launch parameter must be a base64
        encoded JSON object, such as:{' '}
        <code>
          {
...
`}
          ...
          <tr>
            ...
            <td>
              <p>
                Base64-encoded JSON object, the value of which is the patient&apos;s ICN. The format
                of the object will be: <code>{'{ "patient": "1000720100V271387"}'}</code>
              </p>
              <p>
