...
The manage endpoint directs end users to a URL where an they can view which applications currently have access to data and can make adjustments to these access rights.
