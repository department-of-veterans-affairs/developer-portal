...
const WorkingWithOurAPIs = (): JSX.Element => (
  <div>
    ...
    <p>
      Integrating with VA APIs can help your app’s users get faster, more reliable access to VA data.
      Discover what it's like to work with VA APIs, including information about rate limiting,
      feature requests, status updates, and more.
    </p>
    ...
    <VaAccordion uswds>
      <VaAccordionItem uswds header="We’re here for you whenever you have questions.">
        ...
        <p>
          We will triage and escalate issues directly to the API owner as needed.
        </p>
      </VaAccordionItem>
    </VaAccordion>
    ...
    <VaAccordion uswds>
      ...
      >
        <p>
          We have full authorization to operate (ATO) at the FISMA Moderate level. We also
    ...
    <VaAccordion uswds>
      <VaAccordionItem uswds header="Consistent and thorough API documentation.">
        <p>
          To be added to VA Developer, an API needs {' '} <a href="https://swagger.io/docs/specification/about/">
          OpenAPI specification</a> documentation. This documentation should also include a description
          of the API’s purpose, helpful context specific to that API, and examples that demonstrate
           the use of the API. No additional documentation is needed outside of what is published
           on the platform, making it easier for you to integrate with our APIs.
        </p>
      </VaAccordionItem>
    </VaAccordion>
    ...
    <VaAccordion uswds>
      ...
      >
        ...
        <p>
          Through OAuth, we ensure that API interactions are secure and seamless. We
        ...
        <p>
          ...
          to be rotated on a recurring basis, VA can either update the key immediately or
          update it on a rolling basis, where both keys work for a short period of time and the
          user facilitates the update on their end with no downtime. The information passed to
