...
describe('VeteransCrisisLine', () => {
  it('checks that panel displays with correct information.', () => {
    ...
    expect(queryByText('If you are a Veteran in crisis or concerned about one, connect with our caring, qualified responders for confidential help. Many of them are Veterans themselves.')).toBeInTheDocument();
    ...
    expect(listItems[2]).toHaveAttribute('href', 'https://www.veteranscrisisline.net/ChatTermsOfService.aspx?account=Veterans%20Chat');
