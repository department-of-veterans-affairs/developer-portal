...
const GettingStarted = (): JSX.Element => (
  <>
    ...
    <p>
      After you submit the form, we send you an email containing access information for test data
      and the sandbox environment, including a client ID and secret if you can safely store a client
      secret. If you cannot safely store a client secret, we will send you a client ID and you will
      use the <Link to="#pkce-authorization">Proof Key for Code Exchange</Link> (PKCE) flow (
