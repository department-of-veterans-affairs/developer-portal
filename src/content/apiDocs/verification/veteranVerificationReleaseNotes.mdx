### Sep 22, 2021
Veteran Verification API v1 was released including a Disability Rating response change to Date rather than Datetime.  This was introduced as a versioned change to allow API consumers to upgrade at their convenience. We encourage all consumers to migrate to this updated version as v0 will be removed Dec 1, 2021.
