### May 17, 2022
To better meet the FHIR specification for both the Veterans Health and Clinical Health APIs, the following changes have been made about Organization.type in both DSTU2 and R2:
 - For Insurance Companies and Government Agencies, data will be communicated in  Observation.type.code.
 - No change for Organization Type concerning VA Facilities
 - Data for all other Organization types (previously passed in Observation.type.system) will no longer be included in the response.
