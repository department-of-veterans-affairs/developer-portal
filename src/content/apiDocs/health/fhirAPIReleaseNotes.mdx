### December 15, 2020
The following three R4 resources have been made available: `Device`, `Practitioner`, and `PracitionerRole`. Not all US Core searches are yet supported for `Practitioner` and `PracitionerRole`. <br/><br/>
The hold times for `Immunization`s and COVID 19 Lab Results have been eliminated.
