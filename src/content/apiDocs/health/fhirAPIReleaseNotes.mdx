### November 16, 2021
We have added DELETE interaction for the QuestionnaireRespose resource in the Patient Generated Data (PGD) API.

In the Veteran Health API, `Pracitioner` and `PractitionerRole` resources now have new fields.
  -  Practitioner: `qualification.code.text` and `address.period`
