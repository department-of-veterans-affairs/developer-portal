...
To receive a developer token to access an API in a test environment, go to <https://developer.va.gov/apply>.  If you are having trouble using <https://developer.va.gov/apply> or have questions, email [api@va.gov](mailto:api@va.gov) and we will get back to you quickly!
