...
Enabled FHIR _sort parameter, which includes the ability to specify the arrangement of responses by ascending or descending order, for the following R4 resources: 'Observation', 'Encounter', and 'Appointment'.
