...
This anonymous function asynchronously retrieves the client information then starts the express server. Now you should be able to run `node index.js` and navigate to \<yourRedirectURL\> in your browser (⚠️Important: Be sure to use the redirect URL that you registered with). You should see 'Hello World!' on your screen. 
