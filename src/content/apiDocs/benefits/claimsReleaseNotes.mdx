...
-   We deprecated 2 schemas because they were duplicating functionality supported by other schemas:
	...
	2.   `servicePay.militaryRetiredPay.willReceiveInfuture` was deprecated because its functionality is supported by `servicePay.militaryRetiredPay.willReceiveInFuture` and resolves letter case inconsistencies.
