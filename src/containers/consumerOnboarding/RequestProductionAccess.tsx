  ...
  <div className="request-production-access">
    ...
    <CollapsiblePanel panelName="Basic information">
      ...
      <p className="vads-u-margin-top--0">
        ...
        <a href="https://www.accesstocare.va.gov/PWT/SearchWaitTimes" target="_blank">this Access To Care page</a>.
      </p>
    </CollapsiblePanel>
        ...
        <li>
          ...
          <ul>
            ...
            <li>
              ...
              recommend you{' '}
              <a href="https://myhealthapplication.com/list-your-app" target="_blank">register and publish</a> your
              app on this website to show you attest to the{' '}
              <a href="https://www.carinalliance.com/our-work/trust-framework-and-code-of-conduct/" target="_blank">
            ...
            <td>
              <ul className="vads-u-margin-y--0">
                ...
                <li>
                  ...
                  <a href="https://www.w3.org/WAI/WCAG21/quickref/?showtechniques=143#contrast-minimum" target="_blank">
