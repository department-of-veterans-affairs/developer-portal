### May 3, 2022
We added a new FHIR R4 resource to the Veterans Health API (FHIR), [DeviceRequest](http://www.hl7.org/Fhir/devicerequest.html), which supports READ and SEARCH functionality. This resource includes only CPAP and BiPAP data.
