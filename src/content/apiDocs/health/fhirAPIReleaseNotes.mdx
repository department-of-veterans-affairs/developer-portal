### February 24, 2020
We have added support for the FHIR R4 resource `Appointment`. This includes searches by `Patient` and `Location` references and searching by `_lastUpdated` date.
