...
- URL changes for the services. (Legacy production URLs are https://www.ebenefits.va.gov:444/wss-referencedata-services-web/rest/referencedata/v1/`<endpoint name>` and new production URLs are: https://api.va.gov/services/benefits-reference-data/v1/`<endpoint name>`)

Learn more about this API by reviewing the [Benefits Data lookup API documentation](/explore/benefits/docs/benefits_reference_data).
