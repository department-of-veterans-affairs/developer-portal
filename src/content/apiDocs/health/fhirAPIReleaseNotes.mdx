### June 21, 2022
The Veteran's Health API has been renamed to "Patient Health API". This rename is so that our consumers will be able to more easily identify the use-cases of the API. There are no functionality, request/response, or data changes associated with this name change.
