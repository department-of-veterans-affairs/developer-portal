...
- Updated the v1 validation endpoints to use the same validation as their respective submission endpoints. The following endpoints validate in the same way now ([#9112](https://github.com/department-of-veterans-affairs/vets-api/pull/9112)):
